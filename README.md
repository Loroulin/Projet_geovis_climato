...
Par exemple : l'élément HTML principal s'ouvre avec <html> et se ferme avec </html>. À l'intérieur de l'élément <html>, vous pouvez avoir un <head> pour les métadonnées et un <body> pour le contenu visible de la page, chacun ayant sa propre balise d'ouverture et de fermeture.
...
![div de base](structure_html_div.png)
...
Le début du script commencera alors avec: document.addEventListener('DOMContentLoaded', function() {
...
![Illustration menus déroulants](menus_déroulants.png )
